...
static class Constants
{
    ...
    public const int NumVibroTactile = 5;   //only for VMG30+
    ...
    public const float GLOVE_TIMEOUT = 20.0f;                 //timeout before reconnecting the glove if communication is lost
...
static class SensorIndexRightHanded
{
    ...
    //only for VMG30+
    public const int VibroThumb = 0;
    public const int VibroIndex = 1;
    public const int VibroMiddle = 3;
    public const int VibroRing = 2;
    public const int VibroLittle = 4;
...
{
    //VMG30 and VMG30+ sensor indexes
    public const int ThumbPh1 = 9;      //!< thumb 1st phalange
    public const int ThumbPh2 = 8;      //!< thumb 2nd phalange
    public const int IndexPh1 = 7;      //!< index first phalange
    public const int IndexPh2 = 6;      //!< index second phalange
    public const int MiddlePh1 = 5;      //!< index first phalange
    public const int MiddlePh2 = 4;      //!< index second phalange
    public const int RingPh1 = 3;      //!< index first phalange
    public const int RingPh2 = 2;      //!< index second phalange
    public const int LittlePh1 = 1;      //!< index first phalange
    public const int LittlePh2 = 0;      //!< index second phalange
    ...
    //only for VMG30+
    public const int VibroThumb = 4;
    public const int VibroIndex = 3;
    public const int VibroMiddle = 2;
    public const int VibroRing = 1;
    public const int VibroLittle = 0;
